...
There is ONE mockup branch (bim-suite-aviram) and ONE preview site. Every day's
...
BRANCH = "bim-suite-aviram"
PREVIEW_REPO = "https://github.com/dotanomer-hash/BIM-Suite-Aviram.git"
PREVIEW_URL  = "https://dotanomer-hash.github.io/BIM-Suite-Aviram"
...
def main():
    ...
    before_etag = head_etag(PREVIEW_URL + "/index.html")   # baseline, before we push
    ...
    if not pushed:
        ...
        for _ in range(36):
            etag = head_etag(PREVIEW_URL + "/index.html")
    ...
    print("\n" + PREVIEW_URL + "/index.html?v=" + stamp)
